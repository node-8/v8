...
assertEquals("abc\uD834\uDF06def".codePointAt(4), 0xFFFD);
assertEquals("abc\uD834\uDF06def".codePointAt(5), 0xFFFD);
assertEquals("abc\uD834\uDF06def".codePointAt(6), 0xFFFD);
assertEquals("abc\uD834\uDF06def".codePointAt(7), 0x64);
...
assertEquals("\uD834\uDF06def".codePointAt("1"), 0xFFFD);
...
assertEquals("\uD834\uDF06def".codePointAt(0), 0x1D306);
assertEquals("\uD834\uDF06def".codePointAt(1), 0xFFFD);
assertEquals("\uD834\uDF06def".codePointAt(2), 0xFFFD);
assertEquals("\uD834\uDF06def".codePointAt(3), 0xFFFD);
assertEquals("\uD834\uDF06def".codePointAt(4), 0x64);
